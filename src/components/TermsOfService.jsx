        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <Card className="border border-pink-600">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300">
              By accessing and using Herizon, you agree to be bound by these Terms of Service ("Terms"). If you do not agree to all the terms and conditions of this agreement, you are not authorized to use our services.
            </p>
          </Card>
          ...
          <Card className="border border-pink-600">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Herizon will not be liable for any damages, whether direct, indirect, incidental, or consequential, resulting from your use of the service. We do not guarantee the accuracy, completeness, or usefulness of any information on the platform.
            </p>
          </Card>
          ...
          <Card className="border border-pink-600">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300">
              All content on Herizon, including text, graphics, logos, and software, is the property of Herizon or its content suppliers and is protected by international copyright laws.
            </p>
          </Card>
