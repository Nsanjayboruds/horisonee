...
export default function SideBar({
  ...
  return (
    <div className="h-screen">
      ...
      {/* Voice Agent button above sidebar (hidden) */}
      <button
        className="hidden"
        style={{ minWidth: 48 }}
      ...
      {/* Blogs button fixed left side (hidden) */}
      <button
        className="hidden"
        style={{ minWidth: 48 }}
      ...
      {!sidebarVisible && width < 816 && (
        <button
          className="fixed top-4 left-20 p-3 bg-white dark:bg-gray-800 rounded-full z-50 shadow-lg border border-gray-200 dark:border-gray-700"
      ...
      >
        <div className="px-4 py-4 flex flex-col space-y-2">
          ...
          <SidebarLink
            ...
            active={active[2]}
          />
          {/* Blogs SidebarLink removed, now shown as fixed button */}
          <SidebarLink
          ...
          <SidebarLink
            icon={<ActivitySquare size={20} />}
            label="My Health Journal"
            onClick={() => navigate("/tracker")}
            active={active[5]}
          />
          <SidebarLink
            icon={<HeartPulse size={20} />}
            label="Ovulation Planner"
          ...
          <SidebarLink
            ...
            active={active[9]}
          />
          {/* Voice Agent SidebarLink removed */}
          <SidebarLink
            icon={<HeartPulse size={20} />}
            label="HealthLens"
