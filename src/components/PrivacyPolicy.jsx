          ...
          <Card className="border border-pink-600">
            ...
            <ul className="list-disc pl-5 space-y-4 text-gray-700 dark:text-gray-300">
              ...
              <li>
                ...
                rights, property, or safety of Herizon, our users, or the public.
              </li>
            </ul>
          </Card>
          <Card className="border border-pink-600">
            ...
            <p className="text-lg mb-4 text-gray-700 dark:text-gray-300">
              Herizon is designed for young menstruators with parental support.
