  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "The forums are a safe and anonymous space where you can ask questions, share experiences, and connect with other members of the Herizon community.",
      },
    ],
  },
];
        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <Card className="border border-pink-600">
            <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">
              Welcome to Herizon's Help Center
            </h2>
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Find answers to your questions, learn how to use our features, and get the support you need to make the most of your Herizon journey.
            </p>
          </Card>
