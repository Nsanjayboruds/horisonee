        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <Card className="border border-pink-600">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Welcome to the heart of Herizon—a vibrant community where you can connect with other menstruators, share your experiences, and find support without judgment. Our community is built on empathy, respect, and a shared journey toward better health.
            </p>
          </Card>
