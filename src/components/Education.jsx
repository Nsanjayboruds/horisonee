      ...
      >
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="flex justify-between items-center relative">
            {/* See Blogs button fixed left side */}
            <button
              className="fixed top-32 right-4 p-3 bg-pink-200 text-black dark:bg-purple-400 dark:text-black rounded-full z-50 shadow-lg border border-purple-200 dark:border-purple-700 flex items-center gap-2"
              style={{ minWidth: 48 }}
              onClick={() => navigate("/blogs")}
            >See Blogs
              <span className="hidden sm:inline">See Blogs</span>
            </button>
