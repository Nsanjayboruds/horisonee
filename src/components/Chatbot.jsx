...
export function Chatbot() {
  ...
  const handleTabSelect = (key) => {
    ...
    sessionStorage.setItem("Herizon_messages", JSON.stringify([
      {
        role: "assistant",
        content: getTabByKey(key).intro,
      },
      ...
      >
        <div className="chat-header">
          <div className="flex items-center">
            ...
            <h2 className="text-2xl font-bold">Herizon Chatbot</h2>
          </div>
        ...
        <div className="messages-container">
          {!selectedTab && (
            <div className="empty-state w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center flex-col justify-center min-h-screen py-12">
              ...
              <div className="text-center mb-12">
                {/* Voice Agent button above description */}
                  <button
                    className="mb-6 px-4 py-2 bg-pink-200 text-black dark:bg-pink-400 dark:text-black rounded-full shadow border border-pink-200 dark:border-pink-700 flex items-center gap-2 mx-auto"
                ...
                <p className="text-gray-700 dark:text-gray-300 max-w-md sm:max-w-lg lg:max-w-xl mx-auto text-sm sm:text-base lg:text-lg leading-relaxed">
                    I&apos;m your Herizon AI companion, here to chat about anything on your mind.
          ...
          {isTyping && (
            <div className="typing-indicator">
              ...
              <span>Herizon AI is thinking</span>
