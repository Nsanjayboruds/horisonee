...
export default function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'Herizon is designed to accommodate all types of cycles, including irregular ones. Our AI adapts to your unique patterns over time.',
    },
    {
    ...
    },
    {
      ...
      answer:
        "Herizon offers features for all aspects of women's health, including general wellness tracking, nutritional guidance, and mental health support.",
    },
    {
