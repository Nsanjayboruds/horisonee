        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <Card className="border border-pink-600">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Cookies are small data files stored on your computer or mobile device. They help us remember your preferences and provide a better, more personalized experience on Herizon.
            </p>
          </Card>

          <Card className="border border-pink-600">
            <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">
              2. How Herizon Uses Cookies
            </h2>
